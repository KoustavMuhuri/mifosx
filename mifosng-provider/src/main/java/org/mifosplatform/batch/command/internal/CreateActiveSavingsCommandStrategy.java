...
@Component
public class CreateActiveSavingsCommandStrategy implements CommandStrategy {

	  private final SavingsAccountsApiResource savingsAccountsApiResource;

	    @Autowired
	    public CreateActiveSavingsCommandStrategy(final SavingsAccountsApiResource savingsAccountsApiResource) {
	    ...
	    public BatchResponse execute(BatchRequest request, @SuppressWarnings("unused") UriInfo uriInfo) {
	        ...
	        try {
	            ...
	            // client
	            responseBody = savingsAccountsApiResource.submitBulkApplication(request.getBody());
