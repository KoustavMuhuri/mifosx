...
public class BatchHelper {
    ...
    public static BatchRequest createSavingsAccountRequest(final Long requestId,Long productId,Long fieldOfficerId,Long clientID, boolean isactivated){
    	final BatchRequest br = new BatchRequest();
        br.setRequestId(requestId);
        br.setRelativeUrl("savingsaccounts/bulkSavingsSubmit");
        br.setMethod("POST");
        final String body="{\"clientId\":"+ clientID + ",\"date\":\"25 August 2016\",\"active\":"+isactivated+",\"fieldOfficerId\":"+fieldOfficerId+",\"locale\":\"en\",\"dateFormat"
        		+"\":\"dd MMMM yyyy\",\"productId\":"+ productId
                + "}";
